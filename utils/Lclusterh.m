function [uidx,usiz,nruns] = Lclusterh(L,dd,gpterm,gpscale,gpfsize,gpplot,logsy,resdir,rid);

% Hierarchical clustering by inter-hyperplane distance

% D = dist(tril(true(10),-1)); % as per Matlab 'pdist' function

Z = linkage(L,'average',@distfun);
